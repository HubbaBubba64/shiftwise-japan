...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title, description, alternates: { canonical: absoluteUrl(`/${locale}/calculator`), languages: { en: absoluteUrl("/en/calculator"), ja: absoluteUrl("/ja/calculator"), "x-default": absoluteUrl("/en/calculator") } }, openGraph: { title, description, url: absoluteUrl(`/${locale}/calculator`), locale: isJa ? "ja_JP" : "en_US", type: "website", siteName: "BaitoPlan" } };
}
