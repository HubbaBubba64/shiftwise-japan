...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const title = isJa ? "ShiftWise Japan｜留学生の勤務時間・年収予測" : "ShiftWise Japan | Student Work Hours & Income Planner";
  ...
  return {
    ...
    openGraph: { title, description, url: absoluteUrl(`/${locale}`), locale: isJa ? "ja_JP" : "en_US", alternateLocale: isJa ? ["en_US"] : ["ja_JP"], type: "website", siteName: "ShiftWise Japan" },
  };
}
