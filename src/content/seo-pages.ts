...
const pages: SeoPage[] = [
  {
    ...
    title: "International Student Work Hours Calculator Japan | BaitoPlan",
    ...
    intro: "Add every job in one place. BaitoPlan combines your hours and applies the reference for the school period you select.", showCalculator: true,
    sections: [
      { heading: "Combine every part-time job", paragraphs: ["A total from one employer does not show your complete schedule. Enter each job separately and BaitoPlan combines the hours before showing your status."], points: ["Monday-to-Sunday weekly history", "All jobs combined", "Separate normal and official-vacation modes"] },
    ...
    faqs: [
      { question: "Do hours from two jobs count together?", answer: "BaitoPlan combines every job you enter. Check your individual permission and official guidance for the conditions that apply to you." },
  ...
  },
  {
    ...
    title: "留学生の週28時間アルバイト計算ツール｜BaitoPlan（バイトプラン）",
    ...
    sections: [
      { heading: "掛け持ちの勤務時間をまとめて確認", paragraphs: ["勤務先ごとの時間だけでは、1週間全体の働き方がわかりません。仕事を別々に入力すると、BaitoPlan（バイトプラン）が自動で合計します。"], points: ["月曜から日曜までの週単位", "複数の仕事を合計", "通常期間と公式の長期休暇を区別"] },
  ...
  },
  {
    ...
    title: "International Student Part-Time Income Japan | BaitoPlan",
    ...
    sections: [
      ...
      { heading: "Keep the estimate grounded", paragraphs: ["BaitoPlan uses an hours-weighted wage across your jobs. Quiet, likely, and busy scenarios show a range based on the selected school-period history, not a guarantee."] },
    ],
    faqs: [
  ...
  },
  {
    ...
    title: "留学生のアルバイト年収を予測｜BaitoPlan（バイトプラン）",
  ...
  },
  {
    ...
    title: "International Student Long-Vacation Work Japan | BaitoPlan",
    ...
    intro: "Choose official long-vacation mode and enter each shift by day. BaitoPlan combines jobs for each date and shows the weekly total for context.", showCalculator: true,
    sections: [
      ...
      { heading: "Why daily entry matters", paragraphs: ["The configured general reference is 8 hours per day. Five 8-hour days total 40 hours, but BaitoPlan does not label 40 hours as a universal weekly limit."] },
    ],
    faqs: [
  ...
  },
  {
    ...
    title: "留学生の夏休みアルバイト時間を確認｜BaitoPlan（バイトプラン）",
  ...
  },
  {
    ...
    title: "Variable Shift Income Calculator Japan | BaitoPlan",
    ...
    intro: "BaitoPlan gives recent matching weeks more weight and keeps normal-semester history separate from official long-vacation history.", showCalculator: true,
    sections: [
  ...
  },
  {
    ...
    title: "変動シフトのバイト年収予測ツール｜BaitoPlan（バイトプラン）",
